...
public class Main {
    public static String filePath = "task.txt";
    public static ArrayList<String> toDoList;

    public static void main(String[] args) {
        toDoList = readTextFile(filePath);
    ...
    public static ArrayList<String> readTextFile(String filePath) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            System.out.println("Could not open file, running with an empty list.");
        }
        return toDoList;
    }
